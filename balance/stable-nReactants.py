...
outputFileName = 'output/stable-nReactants.csv'


regText = r'.*\.csv'
# regText = r'Histidine-trythis.*\.csv'
# regText = r'Histidine-HIS_CBB\.csv'

reactantsToGet = ['ATP', 'NADH', 'Fdred', 'Sulfate', 'CO2', 'HCO3-', 'HCO2-']
